...
//             appManager.addAppAdministrator(tokenAdmin);
...
//             ProtocolToken(address(protocolTokenProxy)).initialize("Token", "TOK", tokenAdmin); 
//             ProtocolToken(address(protocolTokenProxy)).grantRole(MINTER_ROLE, tokenAdmin);
