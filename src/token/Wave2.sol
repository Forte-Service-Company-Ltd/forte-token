...
import { InterchainTokenStandard } from 'interchain-token-service/interchain-token/InterchainTokenStandard.sol';
import { ERC20 } from 'interchain-token-service/interchain-token/ERC20.sol';
import { Minter } from 'interchain-token-service/utils/Minter.sol';
import { IERC20MintableBurnable } from 'interchain-token-service/interfaces/IERC20MintableBurnable.sol';

import "forge-std/console.sol";

contract Wave2 is InterchainTokenStandard, Minter, ERC20, IERC20MintableBurnable {
